    ...
    public static Map<String,Object> readAPK(String apkUrl){
        ...
        try {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                //自定义
//                else if("meta-inf".equals(zipEntry.getName().toLowerCase())){
//                    if(zipEntry.isDirectory()){
//                        while (enumeration.hasMoreElements()){
//                            ZipEntry zipEntry1 = enumeration.nextElement();
//                                    if(!zipEntry1.isDirectory()){
//                                        if("cert.rsa".equals(zipEntry1.getName().toLowerCase())){
                        ...
                        while (true) {
                            ...
                            if(null != name && name.toLowerCase().equals("manifest")){
                                for (int i = 0; i != parser.getAttributeCount(); i++) {
                                    ...
                                    //自定义
                                    else if("label".equals(parser.getAttributeName(i))){
                                        String label = getAttributeValue(parser,i);
                                        if(null == label){
                                            label = "";
                                        }
                                        map.put("label", label);
                                    ...
                                    map.put("i:"+i,getAttributeValue(parser,i));
                                }
                                break;
                            }
                        }
...
//        String apkUrl = "src/shenmiaotaowang_966.apk";
        String apkUrl = "app/src/jiangSuTouTiao_v2.3.2_2018-01-11_Product.apk";
